...
<body>
                    ...
                    <table id="tipsTable">
                        ...
                        <tbody id="tipsTableBody">
                            <tr>
                                ...
                                <td><button class="btn-view" onclick="viewTip('1')">View</button></td>
                            </tr>
                            <tr>
                                <td>TIP-2024-002</td>
                                ...
                                <td><button class="btn-view" onclick="viewTip('2')">View</button></td>
                            </tr>
                            <tr>
                                <td>TIP-2024-003</td>
                                <td>Vandalism</td>
                                ...
                                <td><span class="status-badge status-pending">Under Review</span></td>
                                <td><button class="btn-view" onclick="viewTip('3')">View</button></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
    ...
    <script>
        ...
        function viewTip(id) {
            alert('Viewing tip: ' + id + ' (Full details modal to be implemented)');
        }
    </script>
</body>
</html>
