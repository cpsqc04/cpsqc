...
/**
 * Admin endpoint: send a tip to Emergency Response (police backup).
 *
 * POST JSON:
...
require_once __DIR__ . '/../includes/emergency_response_forward.php';
...
try {
    ...
    $referenceId = trim($result['emergency_response_reference_id'] ?? '');
