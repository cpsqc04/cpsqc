            ...
            'outbound_from_alertaraqc' => [
                ...
                'endpoints' => [
                    ...
                    endpoint('/api/tip_backup_status_receive.php', [
                        'name' => 'Receive Police Backup Status Update',
                        'methods' => ['POST'],
                        'auth' => 'api_key',
                        'module' => 'Review Tip',
                        'direction' => 'inbound',
                        'groups' => ['emergency-response'],
                        'env_key' => 'EMERGENCY_RESPONSE_API_KEY',
                        'description' => 'Inter-Agency / Emergency Response callbacks for police backup progress. Separate from tanod tip Outcome.',
                        ...
                        'sample_response' => [
                            ...
                            'source_tip_id' => 'TIP-2026-002',
                            'backup_status' => 'Dispatched',
                            'message' => 'Police backup status updated to Dispatched.',
                        ],
                    ]),
                ],
            ],
