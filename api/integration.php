            ...
            'outbound_from_alertaraqc' => [
                ...
                'endpoints' => [
                    endpoint('/api/tip_incident_receive.php', [
                        ...
                        'triggered_by' => 'Admin Review Tip → Forward to Incident Reporting',
                        'description' => 'Reference endpoint Incident Reporting should implement for tip incident logging',
                        'sample_request' => [
                            'source' => 'alertaraqc',
                            'record_type' => 'tip',
                    ...
                    endpoint('/api/coordination_receive.php', [
                        ...
                        'description' => 'Reference endpoint Emergency Response should implement for police backup',
                        'sample_request' => [
                            'source' => 'alertaraqc',
