...
```json
{
  ...
  "supporting_document": "data:application/pdf;base64,JVBERi0xLjQK...",
  "review_notes": ""
}
```

**Supporting document (requester uploads):** send PDF or image as a base64 data URL in `supporting_document` (aliases: `document`, `supporting_documents`). Max 8 MB. HTTPS URL also accepted. AlertaraQC admins will **view only** — they do not upload documents on your behalf.
