...
- **CCTV detection (optional):** Python (`detect.py`) — starts when admin opens **Open Surveillance**, stops on leave / after 10 minutes without heartbeat. Autostart is disabled.
