...
<head>
    ...
    <title>Neighborhood Watch Member Login - AlerTara QC</title>
...
<body>
        ...
        <div class="main-content">
            <section class="hero">
                <div class="welcome-text">
                    ...
                    <p>Secure access for approved neighborhood watch members to report incidents to BPSO.</p>
                </div>
            </section>

            <section class="login-card" aria-labelledby="login-title">
                <h2 id="login-title">Neighborhood Watch Member Login</h2>
    ...
    <script>
        ...
        async function requestOTP(event) {
            ...
            try {
                const response = await fetch('api/nw-forgot-password.php?action=request', {
                    method: 'POST',
        ...
        async function verifyOTP(event) {
            ...
            try {
                const response = await fetch('api/nw-forgot-password.php?action=verify', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
        ...
        async function resetPassword(event) {
            ...
            try {
                const response = await fetch('api/nw-forgot-password.php?action=reset', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
